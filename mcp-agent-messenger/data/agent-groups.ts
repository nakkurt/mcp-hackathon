    ...
    mcpIntegrations: [
      {
        name: "Notion",
        mcp: "Notion MCP",
        resources: ["Health Tracker", "Chore List", "Meal Planner"],
        tools: [
          { name: "list_notion_pages", access: "read" },
          { name: "create_notion_page", access: "write" }
        ]
      },
      {
        name: "Google Calendar",
        mcp: "Google Calendar MCP",
        resources: ["Family Calendar", "Date Nights"],
        tools: [
          { name: "list_calendar_events", access: "read" },
          { name: "create_calendar_event", access: "write" }
        ]
      },
      {
        name: "Gmail",
        mcp: "Gmail MCP",
        resources: ["Personal Inbox"],
        tools: [
          { name: "list_emails", access: "read" },
          { name: "send_email", access: "write" }
        ]
      },
      {
        name: "Google Contacts",
        mcp: "Google Contacts MCP",
        resources: ["Family Contacts"],
        tools: [
          { name: "list_contacts", access: "read" },
          { name: "add_contact", access: "write" }
        ]
      },
      {
        name: "Discord",
        mcp: "Discord MCP",
        resources: ["Family Server"],
        tools: [
          { name: "list_channels", access: "read" },
          { name: "send_message", access: "write" }
        ]
      }
    ]
  },
    ...
    mcpIntegrations: [
      {
        name: "Notion",
        mcp: "Notion MCP",
        resources: ["Trip Planning", "Game Night Schedule"],
        tools: [
          { name: "list_notion_pages", access: "read" },
          { name: "create_notion_page", access: "write" }
        ]
      ...
      },
      {
        name: "Discord",
        mcp: "Discord MCP",
        resources: ["Gaming Server", "Movie Club"],
        tools: [
          { name: "list_channels", access: "read" },
          { name: "send_message", access: "write" }
        ]
    ...
    mcpIntegrations: [
      {
        name: "Notion",
        mcp: "Notion MCP",
        resources: ["Project Tracker", "Meeting Notes"],
        tools: [
          { name: "list_notion_pages", access: "read" },
          { name: "create_notion_page", access: "write" }
        ]
